...
public class User extends AbstractEntity {
    ...
    /* While our class needs one of these encoder objects below, it does not need to be an instance variable.
    We’ll make it static, so it can be shared by all User objects. */
